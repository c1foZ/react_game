...
const Navbar = () => {
  ...
  return (
    <div className='text-white flex justify-between items-center h-28 max-w-[1240px] mx-auto px-4'>
      <h1 className='w-full text-3xl font-bold text-[#ff893b]'>GAME.</h1>
      ...
      >
        <h1 className='w-full text-3xl font-bold text-[#ff893b] m-4'>GAME.</h1>
        <ul className='pt-24 uppercase'>
          <li className='p-4 border-b border-[#ff893ba1]'>
            <Link to={'/'}>Home</Link>
          </li>
          <li className='p-4 border-b border-[#ff893ba1]'>
            <Link to={'/play'}>Play</Link>
